...
> **ملاحظة:** هذا الملف يوثق الحالة القديمة قبل حل مرونة الأدوار. تم استبدال الشروط الحرفية ببنية `role_family` و`account_type` وصلاحيات Spatie. التوثيق الحالي الكامل موجود في [`../resolve-roles.md`](../resolve-roles.md).
