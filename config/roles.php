...
$teacherPermissions = [
    ...
    'إنشاء امتحان',
    'عرض تفاصيل الامتحان',
    // تصحيح علامة أدخلها المدرس خطأً جزء من عمله لا استثناء إداري؛ والتعديل
    // محصور بامتحانات طلاب حلقاته في ExamController::updateExam.
    'تعديل الامتحان',
    'امتحاناتي',
...
$studentCapabilities = [
    ...
    // سجل الحضور لا الغياب وحده: عمود type في الجدول يحمل 'present' أيضاً،
    // فما يراه الطالب هو سجل حضوره كاملاً.
    'attendance' => 'عرض حضوري وغيابي كطالب',
    'notifications' => 'عرض إشعاراتي كطالب',
